...
- **Shortcuts** - Start Menu folder with Start JupyterLab, Stop JupyterLab, Open JupyterLab (`https://localhost/stellars-jupyterlab-ds/jupyterlab`) and Uninstall, plus a JupyterLab desktop shortcut to the same access URL
